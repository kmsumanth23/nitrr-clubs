...
/**
 * Apply form. Known profile fields are shown read-only (pulled from the
 * profile); the 3 generic questions are the actual inputs. Submits to the
 * server action; shows validation/duplicate errors inline.
 */
